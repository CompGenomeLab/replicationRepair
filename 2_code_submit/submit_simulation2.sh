...
# -= Resources =-
#
#SBATCH --job-name=simulation_part2
...
${mainPath}/filter_syn_fasta -in ${mainPath}/inputfasta/${file}_cutadapt_sorted_dipyrimidines.fa -length 10 -sim ${mainPath}/human_sim2.fq -out ${mainPath}/output/${file}_out.fastq
