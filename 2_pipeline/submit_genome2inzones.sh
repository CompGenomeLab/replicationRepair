...
mainPath="/cta/users/cemazgari/repairReplication/data"

genomes=(genome_hg19_20kb_windows.bed genome_hg19_100kb_windows.bed genome_hg19_1Mb_windows.bed)

for genome in ${genomes[@]}; do

bedtools intersect -a ${mainPath}/${genome} -b ${mainPath}/InitiationZones_Hela_updated.bed -wao -F 0.5 > /cta/users/cemazgari/repairReplication/InitiationZones_${genome%.*}.txt
