...
rule mapping2regions_xr:
    ...
    log:
        "logs/rule/analysis/{samples}/{samples}_{build}_mapping2regions_xr_{regions}.log",
    benchmark:
...
rule mapping2regions_ds:
    ...
    params:
        ...
        mappedReads=lambda w, input: mappedReads(input[0], input[1]),
    log:
        "logs/rule/analysis/{samples}/{samples}_{build}_mapping2regions_ds_{regions}.log",
    benchmark:
...
rule mapping2regions_xr_intergenic:
    ...
    params:
        ...
        mappedReads=lambda w, input: mappedReads(input[0], input[1]),
    log:
        "logs/rule/analysis/{samples}/{samples}_{build}_mapping2regions_xr_intergenic_{regions}.log",
    benchmark:
...
rule mapping2regions_ds_intergenic:
    ...
    params:
        ...
        mappedReads=lambda w, input: mappedReads(input[0], input[1]),
    log:
        "logs/rule/analysis/{samples}/{samples}_{build}_mapping2regions_ds_intergenic_{regions}.log",
    benchmark:
...
rule mapping2regions_xr_sim:
    ...
    params:
        ...
        mappedReads=lambda w, input: mappedReads(input[0], input[1]),
    log:
        "logs/rule/analysis/{samples}/{samples}_{build}_sim_mapping2regions_xr_{regions}.log",
    benchmark:
...
rule mapping2regions_ds_sim:
    ...
    params:
        ...
        mappedReads=lambda w, input: mappedReads(input[0], input[1]), 
    log:
        "logs/rule/analysis/{samples}/{samples}_{build}_sim_mapping2regions_ds_{regions}.log",
    benchmark:
...
rule mapping2regions_xr_intergenic_sim:
    ...
    params:
        ...
        mappedReads=lambda w, input: mappedReads(input[0], input[1]),
    log:
        "logs/rule/analysis/{samples}/{samples}_{build}_sim_mapping2regions_xr_intergenic_{regions}.log",
    benchmark:
...
rule mapping2regions_ds_intergenic_sim:
    ...
    params:
        ...
        mappedReads=lambda w, input: mappedReads(input[0], input[1]), 
    log:
        "logs/rule/analysis/{samples}/{samples}_{build}_sim_mapping2regions_ds_intergenic_{regions}.log",
    benchmark:
