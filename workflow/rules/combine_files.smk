rule combine_files:
    input:
        lambda w: combineOutputs(config["build"], config["sample_xr"], config["sample_ds"], config["sample_markers"], w.regions),
    output:
...
rule combine_files_sim:
    input:
        lambda w: combineOutputs(config["build"], config["sample_xr"], config["sample_ds"], config["sample_markers"], w.regions, outformat="sim"),
    output:
...
rule combine_files_intergenic:
    input:
        lambda w: combineOutputs(config["build"], config["sample_xr"], config["sample_ds"], config["sample_markers"], w.regions, outformat="intergenic"),
    output:
...
rule combine_files_sim_intergenic:
    input:
        lambda w: combineOutputs(config["build"], config["sample_xr"], config["sample_ds"], config["sample_markers"], w.regions, outformat="sim_intergenic"),
    output:
...
rule combine_files_tss:
    input:
        lambda w: combineOutputs(config["build"], config["sample_xr"], config["sample_ds"], config["sample_markers"], outformat=w.tss_tes),
    output:
...
rule combine_files_markers_intergenic:
    input:
        lambda w: combineOutputs(config["build"], config["sample_xr"], config["sample_ds"], config["sample_markers"], w.regions, outformat="markers_intergenic"),
    output:
