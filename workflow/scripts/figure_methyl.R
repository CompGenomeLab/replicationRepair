...
######## Arguments ##########
p <- arg_parser("producing the methylation figure")
...
#                    "final_reports_methyl_iz_hela_repdomains_uv_mean0.5_windows_201_100_intergenic.txt",
#                    sep = "")
...
colnames(sample_df) <- c("chromosomes", "start_position", "end_position", "dataset", 
                         ...
                         "methylation", "replicate", "cell", "method", "geo", 
                         "sra", "sample_strand", "mapped_reads", "RPKM")
