...
sample_csv_pA <- paste("/home/azgarian/Documents/myprojects/replicationRepair/",
                       "final/final_reports_hg19_",
                       "repdomains_hela_windows_201_10000_ready.csv", 
                       sep = "")

# name of the sample csv file for plot B
sample_csv_pB <- paste("/home/azgarian/Documents/myprojects/replicationRepair/",
                       "final/final_reports_noWindows_hg19_",
                       "repdomains_hela_ready.csv", 
                       sep = "")
