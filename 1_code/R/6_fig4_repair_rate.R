...
p <- ggplot(d, aes(x = windows, y = log2(xr_ds))) + 
  ...
  labs(color = "Strands")
p.A.2 <- p + p_format + ylim(-1.5, 1.5) + theme(axis.title.x=element_blank(),
...
p <- ggplot(d, aes(x = windows, y = log2(xr_ds))) + 
  ...
  scale_color_manual(values = strand_colors) + 
  labs(color = "Strands")
p.B.2 <- p + p_format + ylim(-1.5, 1.5) + theme(axis.title.x=element_blank(),
                              axis.title.y=element_blank(),
                              axis.text.y=element_blank(),
                              axis.text.x=element_text(hjust=c(0.3, 0.5, 0.7)))
...
p <- ggplot(d, aes(x = windows, y = log2(xr_ds))) + 
  ...
  scale_color_manual(values = strand_colors) + 
  labs(color = "Strands")
p.C.2 <- p + p_format + ylim(-1.5, 1.5) + theme(axis.title.x=element_blank(),
                              axis.title.y=element_blank(),
                              axis.text.y=element_blank(),
                              axis.text.x=element_text(hjust=c(0.3, 0.5, 0.7)))
...
p <- ggplot(d, aes(x = windows, y = log2(xr_ds))) + 
  ...
  scale_color_manual(values = strand_colors) + 
  labs(color = "Strands")
p.D.2 <- p + p_format + ylim(-1.5, 1.5) + theme(axis.title.x=element_blank(),
                              axis.title.y=element_blank(),
                              axis.text.y=element_blank(),
                              axis.text.x=element_text(hjust=c(0.3, 0.5, 0.7)))
...
p <- ggplot(d, aes(x = windows, y = log2(xr_ds))) + 
  ...
  scale_color_manual(values = strand_colors) + 
  labs(color = "Strands")
p.E.2 <- p + p_format + ylim(-1.5, 1.5) + theme(axis.title.x=element_blank(),
                              axis.title.y=element_blank(),
                              axis.text.y=element_blank(),
                              axis.text.x=element_text(hjust=c(0.3, 0.5, 0.7)))
...
p <- ggplot(d, aes(x = windows, y = log2(xr_ds))) + 
  ...
  scale_color_manual(values = strand_colors) + 
  labs(color = "Strands")
p.F.2 <- p + p_format + ylim(-1.5, 1.5) + theme(axis.title.y=element_blank(),
                                                axis.text.y=element_blank(),
                              axis.text.x=element_text(hjust=c(0.3, 0.5, 0.7)))
